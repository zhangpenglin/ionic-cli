...
var argv = require('optimist').argv,
    ...
    IonicInfo = require('./ionic/info').IonicTask;
...
var TASKS = [
  ...
  },
  {
   ...
   },
   {
    ...
    args: {
      '[add|remove]': 'Add or remove default Ionic Cordova hooks'
    },
    module: './ionic/hooks'
  },
  {
   ...
   },
   {
    title: 'base',
    name: 'base',
    summary: 'Base up plugins / platforms / templates',
    args: {
      '<NAME>': 'The base to start with'
    },
    module: './ionic/base'
   }
];

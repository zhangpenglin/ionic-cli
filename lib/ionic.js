...
var TASKS = [
  ...
  },
  {
    title: 'icon',
    name: 'icon',
    summary: 'Automatically create icon resources' + ' (beta)'.yellow,
    module: './ionic/res/icon-build'
  },
  {
    title: 'splash',
    name: 'splash',
    summary: 'Automatically create splash screen resources' + ' (beta)'.yellow,
    module: './ionic/res/splash-build'
  },
  {
    title: 'package',
    name: 'package',

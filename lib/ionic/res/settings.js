...
exports.ResPlatforms = {
  ...
  android: {
    ...
    splash: {
      images: [
        { name: 'land-ldpi-screen.png',    width: 320,   height: 200,   density: 'land-ldpi' },
        { name: 'land-mdpi-screen.png',    width: 480,   height: 320,   density: 'land-mdpi' },
        { name: 'land-hdpi-screen.png',    width: 800,   height: 480,   density: 'land-hdpi' },
        { name: 'land-xhdpi-screen.png',   width: 1280,  height: 720,   density: 'land-xhdpi' },
        { name: 'land-xxhdpi-screen.png',  width: 1600,  height: 960,   density: 'land-xxhdpi' },
        { name: 'land-xxxhdpi-screen.png', width: 1920,  height: 1280,  density: 'land-xxxhdpi' },
        { name: 'port-ldpi-screen.png',    width: 200,   height: 320,   density: 'port-ldpi' },
        { name: 'port-mdpi-screen.png',    width: 320,   height: 480,   density: 'port-mdpi' },
        { name: 'port-hdpi-screen.png',    width: 480,   height: 800,   density: 'port-hdpi' },
        { name: 'port-xhdpi-screen.png',   width: 720,   height: 1280,  density: 'port-xhdpi' },
        { name: 'port-xxhdpi-screen.png',  width: 960,   height: 1600,  density: 'port-xxhdpi' },
        { name: 'port-xxxhdpi-screen.png', width: 1280,  height: 1920,  density: 'port-xxxhdpi' }
      ],
      nodeName: 'splash',
      nodeAttributes: ['src', 'density']
    }
